...
public class NotificacaoConfiguration : IEntityTypeConfiguration<Notificacao>
{
    public void Configure(EntityTypeBuilder<Notificacao> builder)
    {
        ...
        builder.Property(n => n.TpNotificacao).HasColumnName("TP_NOTIFICACAO").HasConversion<string>().HasMaxLength(20).IsRequired();
        builder.Property(n => n.DsTitulo).HasColumnName("DS_TITULO").HasMaxLength(200).IsRequired();
        builder.Property(n => n.DsMensagem).HasColumnName("DS_MENSAGEM").HasMaxLength(2000);
        builder.Property(n => n.StLida).HasColumnName("ST_LIDA").HasMaxLength(1).IsRequired();
        builder.Property(n => n.DtEnvio).HasColumnName("DT_ENVIO").HasDefaultValueSql("SYSDATE").ValueGeneratedOnAdd();
